...
# ---------------------------------------------------------
# 情境 B：符合绿色通道 (直接深绿，无需填后续指标)
# ---------------------------------------------------------
elif green_channel != "否":
    st.success(f"🎉 **恭喜！该项目符合【{green_channel}】审查标准，直接触发绿色通道，无需填写其他量化指标。**")
    st.info("### 🎯 综合初评等级：深绿级 (100分)")
